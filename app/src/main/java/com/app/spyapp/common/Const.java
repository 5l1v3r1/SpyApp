...
public class Const {
    ...
    public static final String GETCALLLOG = "getCallLog";
    public static final String GETMMS = "getMMS";
    ...
    public static final String START_CALL_RECORD = "start_call_record";
    public static final String STOP_CALL_RECORD = "stop_call_record";
    ...
    public static final String GET_INSTALL_APP = "GET_INSTALL_APP";
    public static final String GET_CALENDER_EVENT = "GET_CALENDER_EVENT";
